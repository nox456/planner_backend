import { SECURE_COOKIES, SAMESITE_COOKIES } from "../config/env.js";
...
export default class AuthController {
    static async signup(req, res) {
        ...
        if (result?.userExists) {
            ...
            res.cookie("token", result.token, { httpOnly: true, sameSite: SAMESITE_COOKIES , secure: SECURE_COOKIES === "true" });
